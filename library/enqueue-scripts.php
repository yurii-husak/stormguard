...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	function foundationpress_scripts() {
		...
		//FontAwesome
		wp_enqueue_style( 'font-awesome', get_stylesheet_directory_uri() . '/node_modules/@fortawesome/fontawesome-free/css/all.css');
        ...
        wp_enqueue_script( 'slick-slider-js', 'https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js', '', '1.8.1', true );
